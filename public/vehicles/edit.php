            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="registration_number" name="registration_number" required value="<?php echo htmlspecialchars($vehicle['registration_number'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="Registration Number">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="vehicle_name" name="vehicle_name" required value="<?php echo htmlspecialchars($vehicle['vehicle_name'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="Vehicle Name">
                ...
                <div class="col-12 col-md-4">
                    <div class="form-floating">
                        <input type="number" step="0.01" class="form-control" id="max_load_capacity" name="max_load_capacity" required value="<?php echo number_format((float)$vehicle['max_load_capacity'], 2, '.', ''); ?>" placeholder="Max Capacity">
                ...
                <div class="col-12 col-md-4">
                    <div class="form-floating">
                        <input type="number" step="0.01" class="form-control" id="odometer" name="odometer" value="<?php echo number_format((float)$vehicle['odometer'], 2, '.', ''); ?>" placeholder="Odometer">
                ...
                <div class="col-12 col-md-4">
                    <div class="form-floating">
                        <input type="number" step="0.01" class="form-control" id="acquisition_cost" name="acquisition_cost" value="<?php echo number_format((float)$vehicle['acquisition_cost'], 2, '.', ''); ?>" placeholder="Acquisition Cost">
                ...
                <div class="col-12 col-md-4">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="region" name="region" value="<?php echo htmlspecialchars($vehicle['region'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Operating Region">
