        ...
        <form method="POST" action="edit.php?id=<?php echo $id; ?>" class="needs-validation" novalidate>
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" class="form-control" id="name" name="name" required value="<?php echo htmlspecialchars($driver['name'], ENT_QUOTES, 'UTF-8'); ?>" <?php echo $isSafetyOfficer ? 'disabled' : ''; ?> style="border-radius: 10px;">
                </div>

                <!-- License Number -->
                <div class="col-12 col-md-6">
                    <label for="license_number" class="form-label fw-semibold text-muted small">License Number *</label>
                    <input type="text" class="form-control" id="license_number" name="license_number" required value="<?php echo htmlspecialchars($driver['license_number'], ENT_QUOTES, 'UTF-8'); ?>" <?php echo $isSafetyOfficer ? 'disabled' : ''; ?> style="border-radius: 10px;">
                </div>

                <!-- License Category -->
                <div class="col-12 col-md-4">
                    <label for="license_category" class="form-label fw-semibold text-muted small">License Category *</label>
                    <input type="text" class="form-control" id="license_category" name="license_category" required value="<?php echo htmlspecialchars($driver['license_category'], ENT_QUOTES, 'UTF-8'); ?>" <?php echo $isSafetyOfficer ? 'disabled' : ''; ?> style="border-radius: 10px;">
                </div>

                <!-- License Expiry Date -->
                <div class="col-12 col-md-4">
                    <label for="license_expiry_date" class="form-label fw-semibold text-muted small">License Expiry Date *</label>
                    <input type="date" class="form-control" id="license_expiry_date" name="license_expiry_date" required value="<?php echo $driver['license_expiry_date']; ?>" <?php echo $isSafetyOfficer ? 'disabled' : ''; ?> style="border-radius: 10px;">
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="number" step="0.01" min="0" max="5" class="form-control text-success fw-bold" id="safety_score" name="safety_score" required value="<?php echo number_format((float)$driver['safety_score'], 2, '.', ''); ?>" style="border-radius: 10px;">
                </div>

                <!-- Contact Number -->
                <div class="col-12 col-md-4">
                    <label for="contact_number" class="form-label fw-semibold text-muted small">Contact Number</label>
                    <input type="text" class="form-control" id="contact_number" name="contact_number" value="<?php echo htmlspecialchars($driver['contact_number'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" <?php echo $isSafetyOfficer ? 'disabled' : ''; ?> style="border-radius: 10px;">
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($driver['email'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" <?php echo $isSafetyOfficer ? 'disabled' : ''; ?> style="border-radius: 10px;">
                </div>
            </div>
